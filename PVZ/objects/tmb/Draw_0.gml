...
draw_set_color(c_white)
	...
	draw_text(x+5,y-sprite_height-2,string(zombie[i,1]-25))
	draw_text(x+4,y-sprite_height-1,string(zombie[i,1]-25))
	draw_text(x+4,y-sprite_height,string(zombie[i,1]-25))
	draw_text(x+4,y-sprite_height+1,string(zombie[i,1]-25))
	draw_text(x+6,y-sprite_height-1,string(zombie[i,1]-25))
	draw_text(x+6,y-sprite_height,string(zombie[i,1]-25))
	draw_text(x+6,y-sprite_height+1,string(zombie[i,1]-25))
	draw_text(x+5,y-sprite_height+2,string(zombie[i,1]-25))
...
if summon = true {
	...
	draw_text(x+5,y-sprite_height, string(zombie[i,1]-25))
	draw_text(x+5,y-sprite_height+1, string(zombie[i,1]-25))
